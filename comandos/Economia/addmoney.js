...
$elseif[$toLowerCase[$noMentionMessage]==banco $tolowercase[$noMentionMessage[2]]]
  ...
  $setUserVar[bank;$sum[$getUserVar[bank;$mentioned[1]];$noMentionMessage];$mentioned[1]]
  $description[Foram adicionados **$replaceText[$noMentionMessage;+;] coins** no banco de <@$mentioned[1]>]
...
$elseif[$toLowerCase[$noMentionMessage]==coins $tolowercase[$noMentionMessage[2]]]
  ...
  $setUserVar[bank;$sum[$getUserVar[bank;$mentioned[1]];$noMentionMessage];$mentioned[1]]
  $description[Foram adicionados **$replaceText[$noMentionMessage;+;] coins** do <@$mentioned[1]>]
  $author[$usertag;$authoravatar]
  $color[8000FF]
  $onlyIf[$checkContains[$noMentionMessage;n/;-;.;,]==false;{author:$usertag:$authoravatar}{color:8000FF}{description:<:error:823299033011191808> Coloque um número valido!}]
  $onlyIf[$isNumber[$noMentionMessage]==true;{author:$usertag:$authoravatar}{color:8000FF}{description:<:error:823299033011191808> Coloque um número valido!}]
...
$author[$usertag;$authoravatar]
$color[8000FF]
$description[<:error:823299033011191808> Como usar: \`$getServerVar[prefixo]addmoney @user (coins / banco) (quantia)\`]

$endif
$onlyIf[$checkContains[$toLowerCase[$noMentionMessage];banco;coins]==true;{author:$usertag:$authoravatar}{color:8000FF}{description:<:error:823299033011191808> Como usar: \`$getServerVar[prefixo]addmoney @user (coins / banco) (quantia)\`}]

$onlyIf[$mentioned[1]!=;{author:$usertag:$authoravatar}{color:8000FF}{description:<:error:823299033011191808> Mencione alguem para adicionar o money dela!}]
